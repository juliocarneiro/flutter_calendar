...
class _TableCalendarState extends State<TableCalendar>
  ...
  Widget _buildHeader() {
    DateTime dayPrev =
        widget.calendarController.focusedDay.subtract(Duration(days: 15));
    DateTime dayNext =
    ...
    final children = [
      GestureDetector(
        ...
        child: Container(
          ...
          child: Center(
            child: Text(
              "${DateFormat.LLLL(widget.locale).format(dayPrev)[0].toUpperCase()}${DateFormat.LLLL(widget.locale).format(dayPrev).substring(1)}",
              style: TextStyle(
                  fontSize: 14,
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          child: Center(
            child: Text(
              "${DateFormat.LLLL(widget.locale).format(dayNext)[0].toUpperCase()}${DateFormat.LLLL(widget.locale).format(dayNext).substring(1)}",
              style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.bold,
                  color: Colors.blue),
